        ...
        <div className="cardsGrid">
          ...
          <GeneralCard bgColour="rgb(var(--orange))">
            <p className={styles.endNote}>
              There are many more reasons to follow the vegan lifestyle, these
              are just my main points of reflection. <br />
              <br /> Whatever your reasoning may be, reflect on them when you
              are struggling with cravings, societal pressures, and cultural
              pressures.
            </p>
          </GeneralCard>
        </div>
      </Accordion>
      <Accordion accordionHeader="Environment">test</Accordion>
      <Accordion accordionHeader="Personal Health">test2</Accordion>
    </div>
  );
}

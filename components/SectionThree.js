  ...
  return (
    <div className="cardsGrid">
      ...
      <ImageCard
        ...
        cardText="You can re-soak mushrooms such as shittake, porcini, and wood ear in warm water in about half an hour. These will give your meals massive flavours and unbelievably meaty textures."
      />
    </div>
  );
}
